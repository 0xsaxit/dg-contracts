...
contract SlotMachineLogicOld {
    ...
    function setJackpots(uint256 _minimumBet) public pure returns (uint256[4] memory jackpots) {
    ...
    function randomNumber(bytes32 _localhash) private view returns (uint256 numbers) {
